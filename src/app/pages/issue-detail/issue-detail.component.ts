...
export class IssueDetailComponent implements OnInit {
  ...
  onDelete() {
    if (confirm('Confirm to delete issue')) {
      try {
        this._service.deleteIssue(this.issueDetail.id).subscribe((data) => {
          console.log(data);
        });
      ...
      try {
        this._service.getIssueDetail(issueId).subscribe(
          ...
          () => {
            ...
            this._service.getUser(this.issueDetail.created_by).subscribe(
              (data) => {
